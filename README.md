...
7. ## Second part of hw1
8. ![hw.png](https://github.com/Practical-DevOps-GitHub/fundamentals-github-task-AndriiBanduliak/blob/main/hw.png)

9. Create discord server and add notification when PR was created.

10. For github actions: 
